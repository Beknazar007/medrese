...
const EXACT_MESSAGE_KEYS: Record<string, string> = {
  ...
  "Cannot delete a teacher who still has teaching assignments": "errors.teacher_has_dependents",
  "Cannot delete a student who still has attendance, grade, or note records": "errors.student_has_dependents",
  "Cannot delete a group that still has students or teaching assignments": "errors.group_has_dependents",
  "Cannot delete a subject that still has teaching assignments": "errors.subject_has_dependents",
